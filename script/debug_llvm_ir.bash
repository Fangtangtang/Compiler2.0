...
#执行' bin/mxc -emit-llvm'
source $(dirname $0)/utils.bash

test_bin ravel

# 1. Make temp directory 安全的新文件夹
if [ $# -eq 4 ]; then
    TEMPDIR=$4
...
# 2. Compile the testcase 用我的compiler编译.mx文件为ir
...
# 4. Execute the code with llc 将我的.ll交给clang编译成.s
# clang-17 -S --target=riscv32-unknown-elf "$TEMPDIR/output.ll" -o "$TEMPDIR/output.s.source"
